...
import { Box, Center, Container, Grid, Heading, Image, SimpleGrid, Text } from "@chakra-ui/react"
...
export function Footer() {
    return (
        <Box role="navigation" className="Footer" bg="black" paddingBottom={10}>
            ...
            <Container>
                <SimpleGrid bg="black" color="white" columns={4} templateColumns={{ base: "repeat(1, 1fr)", sm: "repeat(2, 1fr)", lg: "repeat(4, 1fr)" }} spacing={5}>
                    ...
                    <Box colSpan={{ base: 1, md: 4, xl: 4 }}>
                        ...
                        <Center><Image width="50px" alt="Favicon" height="50px" src="https://d1zh5cyxaugen.cloudfront.net/Favicon.png"></Image></Center>
                    ...
                    <Box colSpan={{ base: 1, md: 4, xl: 4 }}>
                        <Heading fontSize={{ base: "15px", md: "20px", lg: "30px" }} fontFamily="'Raleway', sans-serif" mb={5} mt={10}>Useful Links</Heading>
