    ...
    return (
      ...
      <SimpleGrid columns={4} pb="2%" templateColumns={{base:"repeat(1, 1fr)", sm:"repeat(2, 1fr)",lg:"repeat(4, 1fr)" }}>     <Box className="OurTeamBox">
            ...
            <Box className="OurTeamBox" >
              <Center> <Image className="round-picture" src="https://groupprojectdepaul.s3.us-east-2.amazonaws.com/assets/chef2.jpg" alt="logo" /></Center>
            ...
            <Box className="OurTeamBox" >
              <Center> <Image className="round-picture" src="https://groupprojectdepaul.s3.us-east-2.amazonaws.com/assets/server1.jpg" alt="logo" /></Center>
            ...
            <Box className="OurTeamBox">
              <Center> <Image className="round-picture" src="shttps://groupprojectdepaul.s3.us-east-2.amazonaws.com/assets/team.jpg" alt="logo" /></Center>
