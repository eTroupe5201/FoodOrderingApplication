    ...
    return (
        <><div className='Signup' > 
            <Flex alignContent='center' justifyContent='center'>
                <Box title='signup-form-box' id='signup-form-box' bg='#000000' color='#fff' w='35rem' height='100%' m='2rem' p='1.5rem'> 
                    <VStack>
                        <Text fontSize='30px' fontWeight='bold' mb='1rem'> Sign Up for an Account </Text>
                        <Input 
                            id='fname'
                            value={fname} 
